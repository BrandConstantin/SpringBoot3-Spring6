...
# JDBC properties
#
app.datasource.jdbc-url=jdbc:mysql://localhost:3306/employee_directory
...
spring.data.jpa.repository.packages=com.springsecurity.springboot.thymeleaf.dao
spring.data.jpa.entity.packages-to-scan=com.springsecurity.springboot.thymeleaf.entity
...
#
security.datasource.jdbc-url=jdbc:mysql://localhost:3306/spring_security_demo_bcrypt
...
In this case, the package name is: com.springsecurity.springboot.thymeleaf.dao, so Spring Data JPA will scan for JPA repositories in this package. Spring Data JPA makes use of a entity manager factory bean and transacation manager. 
...
This injects the "securityDataSource" bean that was defined in the previous file: DemoDataSourceConfig.java. Then we tell Spring Security to use this data source for JDBC authentication.
